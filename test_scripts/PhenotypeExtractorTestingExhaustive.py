...
test_path = "../output/merged_dataset_with_parents.csv"
...
if __name__ == "__main__":
    ...
    for model in models:
        for prompt_file in prompts:
            ...
            prompt = open("prompts_and_config/" + prompt_file, "r").read()

            summary_file = "../results/summary_exhaustive_" + prompt_file.split(".")[0] + "_" + model.split(":")[0].replace(".", "") + ".csv"

            default_model = model

            if summary_file in os.listdir("../output/"):
                continue
